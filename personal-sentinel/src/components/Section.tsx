 ...
 * raised SIGILL on pre-Haswell CPUs, and an industrial panel PC is exactly the
 * machine that is old). The surface comes from the theme's `.panel` class and
 * nothing here sets a colour.
 *
 * The banned utility is deliberately not named in full anywhere in this
 * codebase: Tailwind v4 scans comments as plain text, so writing it out — even
 * to say it is forbidden — emits the class into the stylesheet.
 */
