...
/**
 * The plant's active alarms, across the top of every section.
 *
 * `role="alert"` and an assertive live region, because this is the one thing
 * on the screen a maintenance engineer must not have to be looking at to
...
export function AlertTicker({ alerts }: AlertTickerProps) {
    ...
    return (
        ...
        >
            ...
            {alerts.length > 1 && (
                <span className="label-mono">+{alerts.length - 1} más</span>
            )}
