    ...
    return (
        <div className="flex h-screen items-center justify-center bg-industrial-950 text-white relative overflow-hidden font-sans selection:bg-cyan-500/30 selection:text-cyan-200">
            ...
            <div className="relative z-10 w-full max-w-5xl p-4">
                <div className="bg-industrial-900/60 backdrop-blur-3xl border border-white/10 rounded-[2.5rem] shadow-[0_0_150px_-30px_rgba(16,185,129,0.15)] flex flex-col md:flex-row overflow-hidden min-h-[600px]">
                    ...
                    <div className="hidden md:flex w-1/2 bg-gradient-to-br from-emerald-900/40 via-industrial-950/60 to-black/40 relative flex-col justify-center items-center p-12 overflow-hidden border-r border-white/5">
                        <div className="absolute top-0 left-0 w-full h-full bg-[radial-gradient(circle_at_50%_50%,_rgba(16,185,129,0.15)_0%,_transparent_60%)]" />
                        <div className="relative z-10 flex flex-col items-center text-center">
                            ...
                            <div className="flex items-center gap-4 mt-2">
                                ...
                                <p className="text-xs font-mono text-emerald-100/70 tracking-[0.3em] uppercase whitespace-nowrap">IoT Powered Platform</p>
                    ...
                    >
                        ...
                        <div className="hidden md:block absolute top-0 right-0 p-8">
                            <div className="text-[10px] font-mono text-gray-600 tracking-widest uppercase">v3.1.0</div>
                        </div>
